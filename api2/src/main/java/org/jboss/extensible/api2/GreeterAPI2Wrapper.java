...
public class GreeterAPI2Wrapper implements API2 {
    private final GreeterImpl delegate;

    public GreeterAPI2Wrapper(final GreeterImpl delegate) {
        this.delegate = delegate;
    }

    @Override
    public char[] greet(final char[] name) {
        return delegate.greet(new String(name)).toCharArray();
    }
